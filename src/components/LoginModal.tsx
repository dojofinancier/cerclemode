...
export const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 transform transition-all duration-300">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-heading font-bold text-teal-900 mb-2">Connexion</h2>
          <p className="text-slate-600">Accède à ton compte Le Cercle des Pères</p>
        </div>
